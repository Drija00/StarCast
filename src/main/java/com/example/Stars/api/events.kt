...
data class UserFollowedEvent(val followId: UUID, val userId: UUID, val followeeUsername: String, val timestamp : LocalDateTime)
data class UserUnfollowedEvent(val followId: UUID, val userId: UUID, val followeeUsername: String, val timestamp : LocalDateTime)
